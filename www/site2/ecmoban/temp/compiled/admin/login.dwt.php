...
<!--[if lte IE 8]>
	<script type="Text/Javascript" language="JavaScript">
    	$(function(){
            ...
            $("#pb-mask").css('cssText','position: fixed; width: 100%; height: 100%; top: 0px; left: 0px; opacity: 1; overflow: hidden; z-index: 100001; background-color:#fff;')
        });
    </script>
<![endif]-->
                ...
                <div class="formContent">
                    ...
                    <div class="formInfo">
                        ...
                        <div class="formText submitDiv">
                            ...
                            <?php else: ?>
                            <span class="submit_span">
                            	<input style="border-radius: 50px;margin:0 auto;display: block;" type="submit"  name="submit" class="sub" value="<?php echo $this->_var['lang']['login']; ?>" />
                            </span>
                            <?php endif; ?>
