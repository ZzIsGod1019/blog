$(function(){
    ...
    Ajax.call('index.php?is_ajax=1&act=check_order','', function(data){
		...
		var total = parseInt(new_orders)+parseInt(await_ship)+parseInt(no_change)+parseInt(booking_goods)+parseInt(goods_report)+parseInt(sale_notice)+parseInt(no_check_goods)+parseInt(no_check_brand)
